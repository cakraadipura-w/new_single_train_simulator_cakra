...
try
    if isfield(cfg,'output_dir') && ~isempty(cfg.output_dir)
        ...
        energy_compare_path = fullfile(cfg.output_dir, 'energy_compare.mat');
    else
        energy_compare_path = 'energy_compare.mat';
    end

    save(energy_compare_path,'compare');
    ...
    warning(['Failed to save energy_compare outputs: ' ME.message]);
end
