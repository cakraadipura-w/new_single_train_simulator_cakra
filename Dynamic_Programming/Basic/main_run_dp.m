...
ALL_SEGMENTS = get_guangzhou_line7_catalog(route_direction, [129, 170, 185, 180, 185, 220, 210, 330]);
...
for i = run_idx
    ...
    seg_file = resolve_project_route_path(project_root, ALL_SEGMENTS(i).file, ALL_SEGMENTS(i).direction);
