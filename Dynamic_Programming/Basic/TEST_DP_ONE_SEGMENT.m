...
script_dir   = fileparts(mfilename('fullpath'));       % .../Dynamic_Programming/Basic/
project_root = fileparts(fileparts(script_dir));       % naik 2 level ke project root
...
max_lambda_value = 10;
summary_output_dir = fullfile(script_dir, 'results');
